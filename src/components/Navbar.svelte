<div class="w-[100vw] h-[15vh] bg-[#344055] font-bold flex flex-row text-white text-3xl justify-center items-center px-5">
    <div class="mr-auto hover:scale-[1.05]">Food Delivery App</div>
